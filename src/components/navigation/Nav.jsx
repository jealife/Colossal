...
import logo from "../../../public/assets/images/CMC-LOGO.png";
...
function MobileNav({ open, setOpen }) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-end filter drop-shadow-md h-20 px-6">
        {" "}
        {/*logo container*/}
      ...
      <div className="menu h-full flex flex-col   px-5  gap-3 text-slate-50">
        <div className="logo py-6 w-full grid place-content-center">
          <Image src={logo} width={300} alt="Logo Clossal" />
        </div>
