...
function MobileNav({ open, setOpen }) {
    ...
    const pathname = usePathname()
    return (
        <div  className={`z-[999] absolute top-0 left-0 h-dvh w-screen bg-black/50 backdrop-blur-3xl transform ${open ? "-translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out filter drop-shadow-sm px-5)  `}>
